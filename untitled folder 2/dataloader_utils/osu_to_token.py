...
from beatmapparser.models import HitCircleOsu, SliderOsu, SpinnerOsu
...
class OsuToToken:
    ...
    def tokenize_osu(self):
        ...
        for hit_object in self.parsed_osu.hit_objects:
            ...
            time_bins = self.quantizers.quantize_time_shift(time_difference_ms)
            time_token_str = f"TIME_SHIFT_{time_bins}"
            ...
            if isinstance(hit_object, HitCircleOsu):
                ...
                slider_dur_bin = self.quantizers.quantize_slider_duration(hit_object.length)
